...
const RceScreen = ({ onMenu, onProfile, onInfo }) => {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        console.warn("Erro ao carregar RCEst", err);
      }
    };
    load();
  }, []);
  ...
  const handleCalculate = useCallback(async () => {
    ...
    try {
      ...
      console.warn("Erro ao salvar RCEst", err);
    }
  }, [form]);
      ...
      >
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <SectionCard>
            ...
            <PrimaryButton label="Calcular RCEst" onPress={handleCalculate} />
          </SectionCard>
          ...
          <SectionCard style={styles.resultsCard}>
            ...
            {result ? (
              ...
              <Text style={styles.placeholder}>
                Preencha os campos e calcule para ver a RCEst.
              </Text>
            )}
          </SectionCard>
